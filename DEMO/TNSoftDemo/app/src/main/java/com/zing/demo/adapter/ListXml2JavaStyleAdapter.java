 ...
 */
public class ListXml2JavaStyleAdapter extends BaseAdapter {

    ArrayList<ListItem> data;
    Context context;

    public ListXml2JavaStyleAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = holder.lil = (ListItemLayout)inflater.inflate(R.layout.lv_xml2java_item_style, parent, false);
            Log.i("TIME_STYLE:", System.currentTimeMillis() - cur + "");
