...
import com.zing.demo.adapter.ListXml2JavaStyleAdapter;
import com.zing.demo.components.ListItem;

import java.util.ArrayList;


public class ActXml2JavaStyle extends ActBase {

    ListView lvList;
    ListXml2JavaStyleAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ListXml2JavaStyleAdapter(this);
