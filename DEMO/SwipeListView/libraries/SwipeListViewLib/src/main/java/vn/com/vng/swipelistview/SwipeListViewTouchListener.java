    ...
    public void move(float deltaX) {
        ...
        if (swipeCurrentAction == SwipeListView.SWIPE_ACTION_DISMISS) {
            ...
            if (deltaX > 0) {
                ...
                if (Math.abs(deltaX) >= viewWidth * BORDER_ONE && Math.abs(deltaX) < viewWidth * BORDER_TWO && !isSetBGOneLeft) {
                ...
                if (Math.abs(deltaX) >= viewWidth * BORDER_ONE && Math.abs(deltaX) < viewWidth * BORDER_TWO && !isSetBGOneRight) {
                    imgTodo.setVisibility(View.VISIBLE);
